  ...
  <div class="post-select">
    <template v-if="courseList.length == 0">
      <span class="blank">
        ...
        Go to 'Explore' to find a course you would like to learn!<br />
        Then you can enter the posting of related course.
      </span>
    </template>
      ...
      <el-card>
        ...
        <div style="padding: 14px">
          ...
          <div class="bottom" divided>
            <el-button type="info" class="button" @click="post(course.cid)"
              >Enter the posting</el-button
            >
          </div>
        </div>
      </el-card>
...
export default defineComponent({
  setup() {
    ...
    const post = async (cid: any) => {
      await store
        .dispatch("course/setLearningCourse", { cid: cid })
        .then(() => {
          router.push("/home/post/view");
        });
    };
    return { courseList, post };
  }
});
</script>
